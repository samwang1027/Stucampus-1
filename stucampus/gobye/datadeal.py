...
def Compare(stu_major,stu_grade,result_now,result_pre,result_fail,creditNeed):
   ...
   # print iget
    ...
    j = 0
    for x in a:
       if not((myFind(x.course_name,result_now,5)==1 or myFind(x.course_name,result_pre,3)==1) and myFind(x.course_name,result_fail,0)==0):
